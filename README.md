...
- The NOR flash can be TSSOP 48 or 56 pin, 8 MB or more, with byte (8-bit) mode support. Regularly used for production is MX29LV640 and S29GL064
...
# Fabricating
4-layer board. Assemble as indicated (DNP = do not populate) in schematic.
